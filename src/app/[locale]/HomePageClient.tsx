  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "url": siteUrl,
        description:
          "Complete Drakantos Wiki resource hub for heroes, classes, PvP modes, dungeons, and progression guides.",
        "logo": {
          "@type": "ImageObject",
        ...
        "image": {
          ...
          width: 1920,
          height: 1080,
          caption: "Drakantos Wiki - Heroes, PvP, Builds, and Dungeons",
        },
        sameAs: [
          "https://drakantos.com/",
      ...
      },
      {
        ...
        genre: ["MMORPG", "Pixel Art", "Action RPG", "Fantasy"],
        numberOfPlayers: {
          minValue: 1,
          maxValue: 1000,
        },
        offers: {
          ...
          url: "https://store.steampowered.com/app/2454980/Drakantos/",
        },
      },
      {
        "@type": "VideoObject",
      ...
      <section className="px-4 py-10 md:py-12">
        <div className="scroll-reveal container mx-auto max-w-6xl">
          <div className="relative overflow-hidden rounded-2xl">
            <VideoFeature
              videoId="CCXVQxJkBtQ"
              title="Drakantos | Official Gameplay Trailer"
            />
          </div>
        </div>
      </section>
            ...
            {t.modules.lucidBlocksCreaturesAndEnemies.creatures.map(
              (c: any, index: number) => (
                ...
                >
                  <div className="mb-3">
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${["Hostile Enemy", "Major Threat", "Elite Threat"].includes(c.role) ? "bg-cyan-500/10 border-cyan-500/30 text-cyan-300" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {c.role}
                    </span>
                  </div>
              ...
              (p: any, index: number) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${p.priority === "Essential" ? "bg-cyan-500/10 border-cyan-500/30 text-cyan-300" : p.priority === "Very High" ? "bg-orange-500/10 border-orange-500/30 text-orange-400" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {p.priority}
                    </span>
                  </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://discord.gg/drakantos"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://steamcommunity.com/app/2454980"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[hsl(var(--nav-theme)/0.1)] border border-[hsl(var(--nav-theme)/0.3)] text-sm hover:bg-[hsl(var(--nav-theme)/0.2)] transition-colors"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://x.com/PlayDrakantos"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
                ...
                <li>
                  <a
                    href="https://www.youtube.com/@playdrakantos"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
                ...
                <li>
                  <a
                    href="https://www.reddit.com/r/drakantos/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >

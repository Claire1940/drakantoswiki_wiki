...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Drakantos Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about Drakantos Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Drakantos Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'About Drakantos Wiki',
      description: 'Learn about our mission to provide the best Drakantos game resources and guides.',
      images: [
        {
    ...
    twitter: {
      ...
      title: 'About Drakantos Wiki',
      description: 'Learn about our mission to provide the best Drakantos game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Drakantos Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Drakantos
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Drakantos Wiki</h2>
            <p>
              Drakantos Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam game "Drakantos". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Drakantos Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Drakantos players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Drakantos Wiki as the <strong>go-to destination</strong> for every Drakantos player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Drakantos Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Drakantos Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Drakantos as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Drakantos mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Drakantos Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Drakantos or any official entities.
            </p>
            <p>
            ...
            <p>
              Drakantos Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@drakantoswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@drakantoswiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@drakantoswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@drakantoswiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@drakantoswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@drakantoswiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@drakantoswiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@drakantoswiki.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Drakantos news.
